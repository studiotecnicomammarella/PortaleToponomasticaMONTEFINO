...
//ol.proj.get("EPSG:6708").setExtent([400923.079213, 4707112.927161, 417139.030186, 4719227.196418]);
var wms_layers = [];
...
var lyr_GoogleTerreno = new ol.layer.Tile({
...
maxResolution:5.600893230452393,
    ...
    creationdate: '2026-03-23 19:41:46',
    interactive: false,
    style: style_Acque,
...
lyr_OpenStreetMap.setVisible(false);lyr_GoogleStrade.setVisible(false);lyr_GoogleTerreno.setVisible(false);lyr_GoogleSatellite.setVisible(true);lyr_GoogleIbrido.setVisible(false);lyr_Acque.setVisible(true);lyr_Strade.setVisible(true);lyr_Particelle.setVisible(true);lyr_Fabbricati.setVisible(true);lyr_NumeriParticelle.setVisible(true);lyr_CIVICI.setVisible(true);lyr_SEZIONIDICENSIMENTOISTAT.setVisible(true);lyr_FogliCatastali.setVisible(true);lyr_CONFINECOMUNALE.setVisible(true);lyr_CONFINIISTAT.setVisible(true);
var layersList = [lyr_OpenStreetMap,lyr_GoogleStrade,lyr_GoogleTerreno,lyr_GoogleSatellite,lyr_GoogleIbrido,group_CATASTO,group_TOPONOMASTICA,lyr_FogliCatastali,lyr_CONFINECOMUNALE,lyr_CONFINIISTAT];
...
lyr_Fabbricati.set('fieldImages', {'fid': 'TextEdit', 'Codice_comune': 'TextEdit', 'Foglio': 'TextEdit', 'Mappale': 'TextEdit', 'Allegato': 'TextEdit', 'Sviluppo': 'TextEdit', 'Htxt': 'TextEdit', 'Rtxt': 'TextEdit', 'Xtxt': 'TextEdit', 'Ytxt': 'TextEdit', 'CATASTO': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
...
lyr_CIVICI.set('fieldImages', {'fid': 'TextEdit', 'CODICE_COMUNE': 'Hidden', 'PROGR_NAZIONALE': 'Hidden', 'PROGR_STRADA': 'Hidden', 'DUG': 'Hidden', 'DENOM_COMPLETA': 'Hidden', 'DENOM_DELIBERA': 'Hidden', 'CODICE_COMUNALE': 'Hidden', 'PROGR_CIVICO': 'Hidden', 'CIVICO': 'Hidden', 'ESPONENTE': 'Hidden', 'SPECIFICITA': 'Hidden', 'SISTEMA_METRICO': 'Hidden', 'PROGRESSIVO_SNC': 'Hidden', 'SEZIONE_DI_CENSIMENTO': 'Hidden', 'NUM_INTERNI': 'Hidden', 'ISOLATO': 'Hidden', 'CODICE_CIVICO_COMUNALE': 'Hidden', 'NON_CONFORMITA': 'Hidden', 'COORDINATA_X': 'TextEdit', 'COORDINATA_Y': 'TextEdit', 'COORDINATA_Z': 'TextEdit', 'FLAG_VALIDAZIONE': 'Hidden', 'METODO': 'Hidden', 'DATA_VALIDITA_AMMINISTRATIVA': 'Hidden', 'NUMERO CIVICO': 'TextEdit', 'INDIRIZZO': 'TextEdit', 'SEZIONE DI CENSIMENTO': 'Range', 'VIA': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
lyr_SEZIONIDICENSIMENTOISTAT.set('fieldImages', {'fid': 'TextEdit', 'COD_REG': 'TextEdit', 'COD_UTS': 'TextEdit', 'PRO_COM': 'TextEdit', 'SEZ21': 'TextEdit', 'SEZ21_ID': 'TextEdit', 'COD_TIPO_S': 'TextEdit', 'TIPO_LOC': 'TextEdit', 'LOC21_ID': 'TextEdit', 'COD_ZIC': 'TextEdit', 'COD_ISAM': 'TextEdit', 'COD_ACQUE': 'TextEdit', 'COD_ISOLE': 'TextEdit', 'COD_MONT_D': 'TextEdit', 'COD_AREA_S': 'TextEdit', 'COM_ASC1': 'TextEdit', 'COM_ASC2': 'TextEdit', 'COM_ASC3': 'TextEdit', 'POP21': 'TextEdit', 'FAM21': 'TextEdit', 'ABI21': 'TextEdit', 'EDI21': 'TextEdit', 'SHAPE_Leng': 'TextEdit', 'SHAPE_Area': 'TextEdit', 'SEZIONE DI CENSIMENTO': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
...
lyr_CONFINIISTAT.set('fieldImages', {'fid': '', 'COD_RIP': 'TextEdit', 'COD_REG': 'TextEdit', 'COD_PROV': 'TextEdit', 'COD_CM': 'TextEdit', 'COD_UTS': 'TextEdit', 'PRO_COM': 'TextEdit', 'PRO_COM_T': 'TextEdit', 'COMUNE': 'TextEdit', 'COMUNE_A': 'TextEdit', 'CC_UTS': 'TextEdit', 'Shape_Leng': 'TextEdit', 'Shape_Area': 'TextEdit', 'layerObject': 'Hidden', 'idO': 'Hidden'});
...
lyr_CIVICI.set('fieldLabels', {'fid': 'hidden field', 'COORDINATA_X': 'hidden field', 'COORDINATA_Y': 'hidden field', 'COORDINATA_Z': 'hidden field', 'NUMERO CIVICO': 'header label - always visible', 'INDIRIZZO': 'header label - always visible', 'SEZIONE DI CENSIMENTO': 'header label - always visible', 'VIA': 'hidden field', });
